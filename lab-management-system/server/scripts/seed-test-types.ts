...
const ROWS: Array<{
  ...
  { category: "concrete", nameEn: "Interlocking Pavers", nameAr: "بلاط انترلوك", code: "CONC_INTERLOCK", unitPrice: "20", unit: "N/mm²", standardRef: "BS EN 1338", formTemplate: "interlock", sortOrder: 40 },
  { category: "concrete", nameEn: "Foam Concrete / Lightweight", nameAr: "خرسانة رغوية", code: "CONC_FOAM", unitPrice: "15", unit: "kg/m³", standardRef: "—", formTemplate: "concrete_foam", sortOrder: 50 },
  ...
  { category: "concrete", nameEn: "Cement Setting Time", nameAr: "زمن تصلب الأسمنت", code: "CEM_SETTING_TIME", unitPrice: "100", unit: "min", standardRef: "ASTM C191 / BS EN 196-3", formTemplate: "cement_setting_time", sortOrder: 60 },
  { category: "concrete", nameEn: "Mortar Sand (Sieve)", nameAr: "رمل ملاط (مناخل)", code: "CONC_MORTAR_SAND", unitPrice: "200", unit: "%", standardRef: "BS EN 13139", formTemplate: "sieve_analysis", sortOrder: 70 },
  ...
  { category: "soil", nameEn: "CBR", nameAr: "نسبة تحمل كاليفورنيا", code: "SOIL_CBR", unitPrice: "250", unit: "%", standardRef: "BS 1377-9", formTemplate: "soil_cbr", sortOrder: 130 },
  { category: "soil", nameEn: "Field Density", nameAr: "كثافة حقلية", code: "SOIL_FIELD_DENSITY", unitPrice: "100", unit: "Mg/m³", standardRef: "BS 1377-9", formTemplate: "soil_field_density", sortOrder: 140 },
  // ─── Steel ──────────────────────────────────────────────────
  ...
  { category: "steel", nameEn: "Anchor Bolt", nameAr: "برغي تثبيت", code: "STEEL_ANCHOR", unitPrice: "300", unit: "kN", standardRef: "—", formTemplate: "steel_anchor_bolt", sortOrder: 220 },
  { category: "steel", nameEn: "Structural Steel", nameAr: "حديد إنشائي", code: "STEEL_STRUCTURAL", unitPrice: "300", unit: "N/mm²", standardRef: "BS EN 10025", formTemplate: "steel_structural", sortOrder: 230 },
  // ─── Asphalt ───────────────────────────────────────────────
  { category: "asphalt", nameEn: "Hot Bin Gradation", nameAr: "تدرج الخلاط الساخن", code: "ASPH_HOTBIN", unitPrice: "50", unit: "%", standardRef: "—", formTemplate: "asphalt_hotbin", sortOrder: 300 },
  ...
  { category: "asphalt", nameEn: "Extracted Aggregate Sieve", nameAr: "مناخل الركام المستخلص", code: "ASPH_EXTRACTED_SIEVE", unitPrice: "100", unit: "%", standardRef: "—", formTemplate: "asphalt_extracted_sieve", sortOrder: 320 },
  { category: "asphalt", nameEn: "Marshall Stability", nameAr: "مارشال", code: "ASPH_MARSHALL", unitPrice: "150", unit: "kN", standardRef: "ASTM D6927", formTemplate: "asphalt_marshall", sortOrder: 330 },
  { category: "asphalt", nameEn: "Marshall Density", nameAr: "كثافة مارشال", code: "ASPH_MARSHALL_DENSITY", unitPrice: "150", unit: "Mg/m³", standardRef: "ASTM D6927", formTemplate: "asphalt_marshall", sortOrder: 331 },
  ...
  { category: "asphalt", nameEn: "Asphalt Core", nameAr: "نواة أسفلت", code: "ASPH_CORE", unitPrice: "75", unit: "Mg/m³", standardRef: "—", formTemplate: "asphalt_core", sortOrder: 340 },
  ...
  // ─── Aggregates ───────────────────────────────────────────
  { category: "aggregates", nameEn: "Aggregate Sieve Analysis", nameAr: "مناخل الركام", code: "AGG_SIEVE", unitPrice: "100", unit: "%", standardRef: "BS EN 933-1", formTemplate: "sieve_analysis", sortOrder: 400 },
  { category: "aggregates", nameEn: "Specific Gravity & Absorption", nameAr: "الوزن النوعي والامتصاص", code: "AGG_SG", unitPrice: "75", unit: "—", standardRef: "BS EN 1097-6", formTemplate: "agg_specific_gravity", sortOrder: 410 },
  ...
  { category: "aggregates", nameEn: "Aggregate Crushing Value (ACV)", nameAr: "قيمة التكسير ACV", code: "AGG_CRUSHING", unitPrice: "100", unit: "%", standardRef: "BS 812-110", formTemplate: "agg_crushing", sortOrder: 430 },
  { category: "aggregates", nameEn: "Aggregate Impact Value (AIV)", nameAr: "قيمة الصدم AIV", code: "AGG_IMPACT", unitPrice: "100", unit: "%", standardRef: "BS 812-112", formTemplate: "agg_impact", sortOrder: 440 },
